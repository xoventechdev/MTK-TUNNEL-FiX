...
import app.openconnect.core.OCService.LocalBinder;

public abstract class VPNConnector {

	public static final String TAG = "OpenConnect";

	public OCService service;
	...
	public abstract void onUpdate(OCService service);
	...
	public VPNConnector(Context ctx, boolean isActivity) {
		...
		Intent intent = new Intent(mContext, OCService.class);
		intent.setAction(OCService.START_SERVICE);
		...
		mContext.registerReceiver(mReceiver, new IntentFilter(
				OCService.ACTION_VPN_STATUS), Context.RECEIVER_EXPORTED);
	...
	public String getByteCountSummary() {
		...
		return mContext.getString(R.string.statusline_bytecount,
				OCService.humanReadableByteCount(newStats.rxBytes, false),
				OCService.humanReadableByteCount(deltaStats.rxBytes, true),
				OCService.humanReadableByteCount(newStats.txBytes, false),
				OCService.humanReadableByteCount(deltaStats.txBytes, true));
	}
