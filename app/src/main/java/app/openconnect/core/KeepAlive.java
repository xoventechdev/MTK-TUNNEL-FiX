...
public class KeepAlive extends BroadcastReceiver {
	...
	private final ocsDeviceStateReceiver mDeviceStateReceiver;

	private final String mDNSHost = "www.google.com";

	public KeepAlive(int seconds, String DNSServer, ocsDeviceStateReceiver deviceStateReceiver) {
	...
	private void scheduleNext(Context context, int delayMs) {
		...
		mPendingIntent = PendingIntent.getBroadcast(context, 0, intent, flags);
