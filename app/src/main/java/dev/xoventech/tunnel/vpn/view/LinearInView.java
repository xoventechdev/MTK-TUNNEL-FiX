...
public class LinearInView extends View {
    ...
    public LinearInView(Context context) {
        super(context);
        initializeView();
    }

    public LinearInView(Context context, AttributeSet attrs) {
        super(context, attrs);
        configureAttributes(attrs);
        initializeView();
    }

    public LinearInView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public LinearInView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void playAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    LinearInView.this.animationProgress = (float)animation.getAnimatedValue();
                    invalidate();
                }
            });
