...
public class LinearOutView extends View {
    ...
    public LinearOutView(Context context) {
        super(context);
        initializeView();
    }

    public LinearOutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        configureAttributes(attrs);
        initializeView();
    }

    public LinearOutView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public LinearOutView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void playAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    LinearOutView.this.animationProgress = (float)animation.getAnimatedValue();
                    invalidate();
                }
            });
