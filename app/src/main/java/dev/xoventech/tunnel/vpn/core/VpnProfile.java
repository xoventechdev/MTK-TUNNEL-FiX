...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static String DEFAULT_DNS2 = "9.9.9.9";
            ...
            case VpnProfile.TYPE_KEYSTORE:
                if (!configForOvpn3) {
                    ...
                    if (ks != null) {
                        ...
                        cfg += context.getResources().getString(R.string.keychain_access) + "\n";
                        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.JELLY_BEAN)
                            if (!mAlias.matches("^[a-zA-Z0-9]$"))
                                cfg += context.getResources().getString(R.string.jelly_keystore_alphanumeric_bug) + "\n";
                    }
                }
                break;
...
//        }
   ...
   /* public void writeConfigFile(Context context) throws IOException {
    ...
    // Used by the Array MultiAdapters
    @Override
