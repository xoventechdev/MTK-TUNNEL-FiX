...
public class RoundCornerLayout extends FrameLayout {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundCorner);

        mCornerRadius = a.getDimension(R.styleable.RoundCorner_cornerRadius, radius);

        if (a.hasValue(R.styleable.RoundCorner_topEnabled)) {
            mTopLeftEnabled = a.getBoolean(R.styleable.RoundCorner_topEnabled, true);
            mTopRightEnabled = mTopLeftEnabled;
        } else {
            mTopLeftEnabled = a.getBoolean(R.styleable.RoundCorner_topLeftEnabled, true);
            mTopRightEnabled = a.getBoolean(R.styleable.RoundCorner_topRightEnabled, true);
        }

        if (a.hasValue(R.styleable.RoundCorner_bottomEnabled)) {
            mBottomLeftEnabled = a.getBoolean(R.styleable.RoundCorner_bottomEnabled, true);
            mBottomRightEnabled = mBottomLeftEnabled;
        } else {
            mBottomLeftEnabled = a.getBoolean(R.styleable.RoundCorner_bottomLeftEnabled, true);
            mBottomRightEnabled = a.getBoolean(R.styleable.RoundCorner_bottomRightEnabled, true);
        }
