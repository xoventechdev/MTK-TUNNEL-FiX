...
public class DragItem {
    ...
    void endDrag(View endToView, AnimatorListenerAdapter listener) {
        ...
        float endX = endToView.getX() - (mDragView.getMeasuredWidth() - endToView.getMeasuredWidth()) / 2f + mDragView.getMeasuredWidth() / 2f;
        float endY = endToView.getY() - (mDragView.getMeasuredHeight() - endToView.getMeasuredHeight()) / 2f + mDragView.getMeasuredHeight() / 2f;
