...
public class Connection
{
	...
	public ConnectionInfo connect(ServerHostKeyVerifier verifier, int connectTimeout, int readTimeout, int kexTimeout)
		...
		catch (IOException e1)
		{
			...
			close(new Throwable("There was a problem during connect.", e1), false);
			...
			throw (IOException) new IOException("There was a problem while connecting to " + hostname + ":" + port, e1);
		}
	}
